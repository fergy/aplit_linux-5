...
static const struct pinctrl_pin_desc msm8909_pins[] = {
	...
	PINCTRL_PIN(112, "SDC1_CLK"),
	PINCTRL_PIN(113, "SDC1_CMD"),
	PINCTRL_PIN(114, "SDC1_DATA"),
...
static const char * const alsp_int_groups[] = { "gpio94" };
static const char * const backlight_en_groups[] = { "gpio37" };
static const char * const blsp_i2c1_groups[] = { "gpio6", "gpio7" };
static const char * const blsp_i2c2_groups[] = { "gpio111", "gpio112" };
static const char * const blsp_i2c3_groups[] = { "gpio29", "gpio20" };
...
static const char * const blsp_uim3_groups[] = { "gpio20", "gpio21" };
...
static const char * const gsm0_tx0_groups[] = { "gpio85" };
static const char * const gyro_accl_groups[] = {"gpio96" };
static const char * const kpsns0_groups[] = { "gpio90" };
static const char * const kpsns1_groups[] = { "gpio91" };
static const char * const kpsns2_groups[] = { "gpio92" };
static const char * const mag_int_groups[] = { "gpio65" };
static const char * const mdp_vsync_groups[] = { "gpio24", "gpio25" };
static const char * const pri_mi2s_groups[] = {
	"gpio59", "gpio60", "gpio62", "gpio63"
};
static const char * const pri_mi2s_ws_groups[] = { "gpio61" };
...
static const struct msm_pingroup msm8909_groups[] = {
	...
	PINGROUP(4, blsp_spi1, blsp_uart1, NA, blsp_spi3_cs3, dmic0_clk, NA, NA, NA, NA),
	PINGROUP(5, blsp_spi1, blsp_uart1, NA, blsp_spi2_cs3, dmic0_data, NA, NA, NA, NA),
	PINGROUP(6, blsp_spi1, blsp_uart1, blsp_i2c1, NA, NA, NA, NA, NA, NA),
	PINGROUP(7, blsp_spi1, blsp_uart1, blsp_i2c1, NA, NA, NA, NA, NA, NA),
	PINGROUP(8, blsp_spi6, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(9, blsp_spi6, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(10, blsp_spi6, blsp_i2c6, NA, NA, NA, NA, NA, NA, NA),
	...
	PINGROUP(14, blsp_spi4, blsp_i2c4, gcc_gp1_clk_b, NA, NA, NA, NA, NA, NA),
	...
	PINGROUP(20, blsp_spi2, blsp_uart2, blsp_uim3, NA, NA, NA, NA, NA, NA),
	PINGROUP(21, blsp_spi2, blsp_uart2, blsp_uim3, NA, NA, NA, NA, NA, NA),
	PINGROUP(22, blsp_spi6, blsp_i2c6, uim3, NA, NA, NA, NA, NA, NA),
	PINGROUP(23, blsp_spi6, blsp_i2c6, uim3, NA, NA, NA, NA, NA, NA),
	...
	PINGROUP(28, webcam1_rst, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(29, blsp_i2c3, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(30, blsp_i2c3, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(31, cci_timer0, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(32, cci_timer1, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(33, cci_async, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(34, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(35, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(36, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(37, backlight_en, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(38, cci_timer2, sd_card, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(39, wcss_bt, NA, NA, NA, NA, NA, NA, NA, NA),
	...
	PINGROUP(45, wcss_fm, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(46, wcss_fm, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(47, wcss_bt, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(48, wcss_bt, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(49, uim2, gcc_gp1_clk_a, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(50, uim2, gcc_gp2_clk_a, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(51, uim2, gcc_gp3_clk_a, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(52, uim2, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(53, uim1, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(54, uim1, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(55, uim1, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(56, uim1, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(57, uim_batt, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(58, NA, smb_int, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(59, cdc_pdm0, pri_mi2s, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(60, cdc_pdm0, pri_mi2s, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(61, cdc_pdm0, pri_mi2s_ws, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(62, cdc_pdm0, pri_mi2s, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(63, cdc_pdm0, pri_mi2s, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(64, cdc_pdm0, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(65, mag_int, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(66, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(67, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(68, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(69, blsp_spi3_cs3, NA, NA, NA, NA, NA, NA, NA, NA),
	...
	PINGROUP(85, gsm0_tx0, NA, NA, NA, NA, NA, NA, NA, NA),
	...
	PINGROUP(90, kpsns0, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(91, kpsns1, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(92, kpsns2, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(93, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(94, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(95, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(96, gyro_accl, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(97, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(98, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(99, sd_write, NA, NA, NA, NA, NA, NA, NA, NA),
	...
	PINGROUP(110, blsp_spi1_cs1, NA, NA, NA, NA, NA, NA, NA, NA),
...
MODULE_DESCRIPTION("Qualcomm msm8909 pinctrl driver");
