...
static const struct regulator_desc pm8909_pldo = {
	.linear_ranges = (struct regulator_linear_range[]) {	//   MIN - MAX     
		REGULATOR_LINEAR_RANGE(750000, 0, 208, 12500),		// 750000-3335000
	},
	.n_linear_ranges = 1,
	.n_voltages = 209,
	.ops = &rpm_smps_ldo_ops,
...
static const struct regulator_desc pm8909_nldo = {
	.linear_ranges = (struct regulator_linear_range[]) {
		REGULATOR_LINEAR_RANGE(375000, 0, 93, 12500),		// 375000-1535500
	},
	.n_linear_ranges = 1,
	.n_voltages = 94,
	.ops = &rpm_smps_ldo_ops,
...
static const struct regulator_desc pm8909_buck_lvo_smps = {
	.linear_ranges = (struct regulator_linear_range[]) {
		REGULATOR_LINEAR_RANGE(375000, 0, 95, 12500),      // 375000-1550000
		REGULATOR_LINEAR_RANGE(750000, 96, 127, 25000),    // 750000-1500000
	},
	.n_linear_ranges = 2,
	.n_voltages = 128,
	.ops = &rpm_smps_ldo_ops,
...
static const struct regulator_desc pm8909_buck_hvo_smps = {
	.linear_ranges = (struct regulator_linear_range[]) {
		REGULATOR_LINEAR_RANGE(1550000, 0, 63, 25000),		// 1550000-2300000
	},
	.n_linear_ranges = 1,
	.n_voltages = 32,
	.ops = &rpm_smps_ldo_ops,
...
static const struct rpm_regulator_data rpm_pm8909_regulators[] = {
	{ "s1", QCOM_SMD_RPM_SMPA, 1, &pm8909_buck_lvo_smps, "vdd_s1" },
	{ "s2", QCOM_SMD_RPM_SMPA, 2, &pm8909_buck_hvo_smps, "vdd_s2" },
	{ "s3", QCOM_SMD_RPM_SMPA, 3, &pm8909_buck_lvo_smps, "vdd_s3" },
	{ "s4", QCOM_SMD_RPM_SMPA, 4, &pm8909_buck_hvo_smps, "vdd_s4" },
	{ "l1", QCOM_SMD_RPM_LDOA, 1, &pm8909_nldo, "vdd_l1_l2_l3" },
	{ "l2", QCOM_SMD_RPM_LDOA, 2, &pm8909_nldo, "vdd_l1_l2_l3" },
	{ "l3", QCOM_SMD_RPM_LDOA, 3, &pm8909_nldo, "vdd_l1_l2_l3" },
	{ "l4", QCOM_SMD_RPM_LDOA, 4, &pm8909_pldo, "vdd_l4_l5_l6" },
	{ "l5", QCOM_SMD_RPM_LDOA, 5, &pm8909_pldo, "vdd_l4_l5_l6" },
	{ "l6", QCOM_SMD_RPM_LDOA, 6, &pm8909_pldo, "vdd_l4_l5_l6" },
	{ "l7", QCOM_SMD_RPM_LDOA, 7, &pm8909_pldo, "vdd_l7" },
	{ "l8", QCOM_SMD_RPM_LDOA, 8, &pm8909_pldo, "vdd_l8_l18" },
	{ "l9", QCOM_SMD_RPM_LDOA, 9, &pm8909_pldo, "vdd_l8_l18" },
	{ "l10", QCOM_SMD_RPM_LDOA, 10, &pm8909_nldo, "vdd_l10"},
	{ "l11", QCOM_SMD_RPM_LDOA, 11, &pm8909_pldo, "vdd_l8_l18"},
	{ "l12", QCOM_SMD_RPM_LDOA, 12, &pm8909_pldo, "vdd_l8_l18"},
	{ "l13", QCOM_SMD_RPM_LDOA, 13, &pm8909_pldo, "vdd_l8_l18"},
	{ "l14", QCOM_SMD_RPM_LDOA, 14, &pm8909_pldo, "vdd_l8_l18"},
	{ "l15", QCOM_SMD_RPM_LDOA, 15, &pm8909_pldo, "vdd_l8_l18"},
	{ "l17", QCOM_SMD_RPM_LDOA, 17, &pm8909_pldo, "vdd_l8_l18"},
	{ "l18", QCOM_SMD_RPM_LDOA, 18, &pm8909_pldo, "vdd_l8_l18"},
	{}
};
...
static const struct rpm_regulator_data rpm_pm8909_regulators[] = {
	...
	{ "l6", QCOM_SMD_RPM_LDOA, 6, &pm8909_pldo, "vdd_l4_l5_l6" },
	{ "l7", QCOM_SMD_RPM_LDOA, 7, &pm8909_pldo, "vdd_l7" },
	{ "l8", QCOM_SMD_RPM_LDOA, 8, &pm8909_pldo, "vdd_l8_l9_l10_l11_l12_l13_l14_l15_l17_l18" },
	{ "l9", QCOM_SMD_RPM_LDOA, 9, &pm8909_pldo, "vdd_l8_l9_l10_l11_l12_l13_l14_l15_l17_l18" },
	{ "l10", QCOM_SMD_RPM_LDOA, 10, &pm8909_nldo, "vdd_l8_l9_l10_l11_l12_l13_l14_l15_l17_l18"},
	{ "l11", QCOM_SMD_RPM_LDOA, 11, &pm8909_pldo, "vdd_l8_l9_l10_l11_l12_l13_l14_l15_l17_l18"},
	{ "l12", QCOM_SMD_RPM_LDOA, 12, &pm8909_pldo, "vdd_l8_l9_l10_l11_l12_l13_l14_l15_l17_l18"},
	{ "l13", QCOM_SMD_RPM_LDOA, 13, &pm8909_pldo, "vdd_l8_l9_l10_l11_l12_l13_l14_l15_l17_l18"},
	{ "l14", QCOM_SMD_RPM_LDOA, 14, &pm8909_pldo, "vdd_l8_l9_l10_l11_l12_l13_l14_l15_l17_l18"},
	{ "l15", QCOM_SMD_RPM_LDOA, 15, &pm8909_pldo, "vdd_l8_l9_l10_l11_l12_l13_l14_l15_l17_l18"},
	{ "l17", QCOM_SMD_RPM_LDOA, 17, &pm8909_pldo, "vdd_l8_l9_l10_l11_l12_l13_l14_l15_l17_l18"},
	{ "l18", QCOM_SMD_RPM_LDOA, 18, &pm8909_pldo, "vdd_l8_l9_l10_l11_l12_l13_l14_l15_l17_l18"},
	{}
};*/
