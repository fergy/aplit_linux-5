...
static const char * const dsi_8909_bus_clk_names[] = {
	"mdp_core", "iface", "bus",
};

static const struct msm_dsi_config msm8909_dsi_cfg = {
	.io_offset = DSI_6G_REG_SHIFT,
	.reg_cfg = {
		.num = 3,
		.regs = {
	...
	.bus_clk_names = dsi_8909_bus_clk_names,
	.num_bus_clks = ARRAY_SIZE(dsi_8909_bus_clk_names),
	.io_start = { 0x1a98000 },
	.num_dsi = 1,
};
...
static const struct msm_dsi_cfg_handler dsi_cfg_handlers[] = {
	...
	{MSM_DSI_VER_MAJOR_6G, MSM_DSI_6G_VER_MINOR_V1_1,
		&msm8909_dsi_cfg, &msm_dsi_6g_host_ops},
