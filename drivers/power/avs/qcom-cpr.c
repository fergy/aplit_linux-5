...
static struct corner_data msm8909_corner_data[] = {
...
static const struct cpr_desc msm8909_desc = {
	.num_fuse_corners = 3,
	...
	.speed_bin = { 12, 3, 2 },
	.pvs_version = { 6, 2, 7 },
	.corner_data = msm8909_corner_data,
	.num_corners = ARRAY_SIZE(msm8909_corner_data),
	.num_freq_plans = 3,
	.freq_plans = (struct freq_plan[]){
		{
			...
			.plan = (const struct corner_data* []){
				msm8909_corner_data + 0,
				msm8909_corner_data + 1,
				msm8909_corner_data + 2,
				msm8909_corner_data + 3,
				msm8909_corner_data + 4,
				msm8909_corner_data + 5,
				msm8909_corner_data + 6,
				msm8909_corner_data + 7,
				NULL
			},
		},
		{
...
static const struct of_device_id cpr_descs[] = {
	{ .compatible = "qcom,qfprom-msm8909", .data = &msm8909_desc },
	{ }
};

static const struct of_device_id acc_descs[] = {
	{ .compatible = "qcom,tcsr-msm8909", .data = &msm8909_acc_desc },
	{ }
};
